...
public class EmployeesByPositionReport {
  @DAttr(name = "id", id = true, auto = true, type = Type.Integer, length = 5, optional = false, mutable = false)
  private int id;
  private static int idCounter = 0;

  /**input: student name */
  @DAttr(name = "position", type = Type.String, length = 30, optional = false)
  ...
  @DAttr(name="employees",type=Type.Collection,optional=false, mutable=false,
      ...
      attributes={Employee.A_id, Employee.A_position, Employee.A_name, 
    		  Employee.A_warehouse, Employee.A_phone, Employee.A_address, Employee.A_dob, 
    		  Employee.A_rptEmployeesByPosition})
      ,derivedFrom={"position"}
      )
  @DAssoc(ascName="employees-by-position-report-has-employees",role="report",
  ...
  public EmployeesByPositionReport(@AttrRef("position") String position) throws NotPossibleException, DataSourceException {
    this.id=++idCounter;
   ...
   *  </pre>
   */
  public void setPosition(String position) throws NotPossibleException, DataSourceException {
//    boolean doReportQuery = (name != null && !name.equals(this.name));
  ...
  public void doReportQuery() throws NotPossibleException, DataSourceException {
    ...
    Query q = QueryToolKit.createSearchQuery(dsm, Employee.class, 
        new String[] {Employee.A_position}, 
        new Op[] {Op.MATCH}, 
        new Object[] {"%"+position+"%"});
  ...
  public boolean addStudent(Collection<Employee> employeess) {
    // do nothing
    return false;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    EmployeesByPositionReport other = (EmployeesByPositionReport) obj;
    if (id != other.id)
      return false;
    return true;
  }
  ...
  public String toString() {
    return "EmployeesByPositionReport (" + id + ", " + position + ")";
  }
