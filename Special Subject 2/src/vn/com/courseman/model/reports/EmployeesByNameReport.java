...
public class EmployeesByNameReport {
  ...
  @DAttr(name="employees",type=Type.Collection,optional=false, mutable=false,
      ...
      attributes={Employee.A_id, Employee.A_position, Employee.A_name, Employee.A_warehouse, 
    		  Employee.A_phone, Employee.A_address, Employee.A_dob,
    		  Employee.A_rptEmployeesByName})
      ,derivedFrom={"name"}
      )
