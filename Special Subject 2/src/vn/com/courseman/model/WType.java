...
public class WType {
  ...
  @DAssoc(ascName="type-has-watermelon",role="type",
  ...
  public WType(@AttrRef("name") String name) {
    this(null, name);
  }

  // constructor to create objects from data source
  @DOpt(type=DOpt.Type.DataSourceConstructor)
  public WType(@AttrRef("id") Integer id,@AttrRef("name") String name) {
    this.id = nextID(id);
    this.name = name;
  ...
  @DOpt(type=DOpt.Type.LinkAdder)
  public boolean addStudent(Collection<Watermelon> watermelons) {
  ...
  @DOpt(type=DOpt.Type.LinkAdderNew)
  public boolean addNewStudent(Collection<Watermelon> watermelons) {
  ...
  //only need to do this for reflexive association: @MemberRef(name="students")
  public boolean removeStudent(Watermelon s) {
  ...
  @DOpt(type=DOpt.Type.Setter)
  public void setStudents(Collection<Watermelon> watermelons) {
